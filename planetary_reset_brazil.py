# -*- coding: utf-8 -*-
"""Planetary_Reset_Brazil.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ltMJawtp1VeUnQUTnGSC-x7ZIkdP8yY-
...
encoding = "utf_8"
country_group = pd.read_csv("/content/drive/MyDrive/gleam/FAOSTAT/FAOSTAT_Country_Group.csv",encoding = encoding)
fao_countries = list((pd.read_csv("/content/drive/MyDrive/gleam/Inputs/fao_countries.csv", encoding = encoding))['Area'].unique())

country_aliases = pd.read_csv("/content/drive/MyDrive/gleam/Inputs/country_aliases.csv",encoding = encoding)
country_alias_map = {}
...
datafile = "/content/drive/MyDrive/gleam/FAOSTAT/Filtered/Environment_Emissions_by_Sector_E_All_Data_(Normalized).csv"
...
df = fao_emissions_pt.reset_index()[['Item','Element', 2019]]
print(fao_emissions_pt.reset_index()[['Item','Element',2019]])
df = df[df.Element.isin(['CO2 emissions','CH4 emissions','N2O emissions'])]
...
fao_emissions_c_2019 = df.pivot_table(index=['Element'],columns='Item').fillna(0)
...
gleamall = pd.read_csv("/content/drive/MyDrive/gleam/GLEAM/GLEAM.csv", encoding=encoding)
...
gleam2 =  pd.read_excel(open("/content/drive/MyDrive/gleam/GLEAM/GLEAM_Data_public_release.xlsx", 'rb'),sheet_name = "GLEAM_GRL", skiprows=2)
...
gleam2_c = pd.read_excel(open("/content/drive/MyDrive/gleam/GLEAM/GLEAM_Data_public_release.xlsx", 'rb'),sheet_name = "COUNTRY_LIST", index_col=None, header=None, names=["Country"])
...
datafile = "/content/drive/MyDrive/gleam/Inputs/FAOSTAT_production_categories.csv"
fao_production_categories = pd.read_csv(datafile,encoding = encoding)
        
datafile = "/content/drive/MyDrive/gleam/FAOSTAT/Filtered/Production_LivestockPrimary_E_All_Data_(Normalized).csv"
...
datafile = "/content/drive/MyDrive/gleam/FAOSTAT/Filtered/Trade_Crops_Livestock_E_All_Data_(Normalized).csv"

fao_livestock_trade = pd.read_csv(datafile)
print(fao_livestock_trade)   
year = np.nanmax(fao_livestock_trade.Year.values)
print(fao_livestock_trade.Year.values)
...
livestock_data = livestock_data[livestock_data["Area"] == "Brazil"]
...
datafile = "/content/drive/MyDrive/gleam/FAOSTAT/Filtered/Trade_DetailedTradeMatrix_E_All_Data_(Normalized).csv"
...
livestock_data = livestock_data.merge(import_landuse,on=['Category'],how='left')
livestock_data = livestock_data.merge(export_landuse,on=['Category'],how='left')
...
faocrops = pd.read_csv("/content/drive/MyDrive/gleam/FAOSTAT/Filtered/FoodSupply_Crops_E_All_Data_(Normalized).csv")
faocrops[(faocrops.Area == "World") & (faocrops.Year == 2013) & (faocrops.Item == "Grand Total")]

faols = pd.read_csv("/content/drive/MyDrive/gleam/FAOSTAT/Filtered/FoodSupply_LivestockFish_E_All_Data_(Normalized).csv")
...
livestock_data.to_csv("/content/drive/MyDrive/gleam/Outputs/country_livestock_data.csv",index=False)
...
ssp_iam = pd.read_csv("/content/drive/MyDrive/gleam/SSP/SSP_IAM_V2_201811.csv/SSP_IAM_V2_201811.csv")
...
scenarios.to_csv("/content/drive/MyDrive/gleam/Outputs/Scenarios.csv")
calib_scenarios.to_csv("/content/drive/MyDrive/gleam/Outputs/Calibration_Scenarios.csv")
...
pop = pd.read_csv("/content/drive/MyDrive/gleam/FAOSTAT/Filtered/Population_E_All_Data_(Normalized).csv",encoding = 'latin-1')
...
table1.to_csv("/content/drive/MyDrive/gleam/Outputs/Table1.csv", index=False)
...
fignum = 1
pdffile = "/content/drive/MyDrive/gleam/Figures_Brazil/Figure%d.pdf" % fignum
...
fignum = 1
supnum = 1
pdffile = "/content/drive/MyDrive/gleam/Figures_Brazil/Figure%d-S%d.pdf" % (fignum,supnum)
...
def Figure2(plotname,plotlabel,plotcaption,scen,scenlabel,scen2="",scen2label=""):
    ...
    pdffile = "/content/drive/MyDrive/gleam/Figures_Brazil/%s.pdf" % plotname
...
fignum = 3
supnum = 2
pdffile = "/content/drive/MyDrive/gleam/Figures_Supplements/Figure%d-S%d.pdf" % (fignum,supnum)
...
def EmLeCRFCalib_plot(plotname,plotlabel,plotcaption,scen,scenlabel,scen2="",scen2label=""):
    ...
    pdffile = "/content/drive/MyDrive/gleam/Figures_Supplements/%s.pdf" % plotname
